...
import matplotlib.pyplot as plt	# Đồ họa					# (pip install matplotlib)
import seaborn as sns			# Đồ họa					# (pip install seaborn)


import statsmodels.api as sm	# Thống kê			# (pip install statsmodels)
#import tensorflow as tf							# (pip install tensorflow)
import probflow as pf								# (pip install probflow)
#import tensorflow as tf							# (pip install tensorflow)

import scipy.stats as ss		# Thống kê			# (pip install scipy)
...
#3
plt.rcParams.update({'font.size': 15})	# Cỡ chữ
bicolor = ['#e6154c', '#0e89ed']		# Hệ màu nhị phân
fill = ['Greens','YlOrRd','Reds']		# Tạo 2 phổ màu liên tục/rời rạc cho 3 phân nhóm
edge = ['#73cc06', '#fcba03', '#fc035a']

#4
cur_path = os.getcwd()
viz_folder = os.path.join(cur_path, 'Graph')		# Tạo folder lưu hình ảnh trực quan
output_folder = os.path.join(cur_path, 'Output')	# Tạo folder lưu các kết quả sơ khởi
